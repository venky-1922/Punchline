  ...
  return (
    ...
    >
      <div className="h-fit lg:w-[40%] sm:w-[80%] ">
        ...
        <div className="text-[clamp(8px,4vw,20px)] text-justify text-[#33737E] mb-7">
      ...
      <div className="flex flex-col flex-wrap gap-8 sm:flex-col sm:items-center lg:flex-row md  justify-end">
        <div className="w-[100%] sm:w-[40%]">
          <Image
            ...
            height={500}
          />
          <p className="mb-8 text-justify w-[80%] text-[#33737E] text-[clamp(8px,3.5vw,16px)] ">
        ...
        <div className="w-[100%] sm:w-[40%]">
          <Image
            ...
            height={500}
          />
          <p className="mb-8 text-justify w-[70%] text-[#33737E] text-[clamp(8px,3.5vw,16px)]">
